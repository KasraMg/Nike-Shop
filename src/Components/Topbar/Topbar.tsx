        ...
        <ul className="flex gap-6 sm:hidden">
          <WavyLink duration={1000} color="#024742" to="/">
            <li
              ...
              } cursor-pointer font-bold outline-0 font-playpen`}
            >
              Home
            </li>
          </WavyLink>
          <WavyLink duration={1000} color="#024742" to="/Contact">
            {" "}
            <li
              className={`${
                location.pathname == "/Contact" ? "text-black" : "text-gray-600"
              } cursor-pointer font-bold outline-0 font-playpen whitespace-nowrap`}
            >
              Contact us
            </li>
          </WavyLink>
          <WavyLink duration={1000} color="#024742" to="/Products">
            <li
              className={`${
