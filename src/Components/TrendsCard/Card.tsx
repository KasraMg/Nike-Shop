...
const Card = () => {
  return (
    <div style={{boxShadow: '-11px 11px 1px rgba(0, 0, 0, 0.3)'}} className=" rounded-3xl w-[300px]">

    <section className="relative h-[252px] bg-[#fa782e] card-head pt-10"> 
      <img style={{transform:' rotate3d(-174, 1000, 104, 578deg)'}} src="/a3a62194837f1ba391316da6ae1de5d6a48d275f_1675779303-removebg-preview.png" alt="Shoe" className="absolute z-50 left-0 ml-[70px] -mt-[16px] " />
