...
const ContactUs = () => {
  ...
  return (
    <div className='mt-20 '>
      <section className='bg-[#2a6e6a] py-16 flex justify-around'>
       
        <div className='space-y-8 relative'>
          <p className='text-white text-4xl font-[cursive]'>Nike shop  is open from 9 am to 12 pm</p>
          <p className='text-white text-4xl font-[cursive]'>We do not have another shop</p>
          ...
          <p className='text-white absolute bottom-2 text-4xl font-[cursive]'>Germany, Berlin, VoBstraBe Street</p>
        </div>
        <Map />
      </section>
      ...
      <section className='bg-[#fdfdfd] py-16 flex items-center justify-around'>
        <div className='relative'>
          <SiJordan className=' text-white text-[400px]  absolute left-[150px] top-[100px]'  />
         <img className='w-[700px]   ' src="/images/graph.png " alt="" />
        </div>
